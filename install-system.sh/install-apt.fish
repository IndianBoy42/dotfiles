...
# sudo nala install autoconf-archive gnu-standards autoconf-doc bison-doc clang-12-doc cmake-doc dh-make aufs-tools \
...
sudo nala install (cat libs.apt)
sudo nala install (cat apps.apt)
