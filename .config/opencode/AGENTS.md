Use the question tool freely, rather then ending your response with a question:
...
Check whether you are in a git repo `.git` or a jujutsu repo `.jj`, load the jujutsu skill if you need to work with it
