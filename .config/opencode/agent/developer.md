---
description: >-
  Use this agent when you need to implement a complex coding task that has been well specified and yet requires advanced knowledge or big picture thinking. Examples: <example>Context: A
  ...
  validation' assistant: 'I'll use the developer agent to implement this
  ...
  implementation, so use the developer agent.</commentary></example>
  ...
  developer agent to implement the phone number validation and formatting
