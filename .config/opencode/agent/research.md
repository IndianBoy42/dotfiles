...
## skill: allow # Ask before loading research skills question: deny external_directory: ask doom_loop: deny lsp: deny
...
1. **Conduct initial survey** of the landscape
...
1. **Delegate to `tech` for specific sub-questions**
...
1. **Synthesize findings** for the branch
...
1. **Map relationships** between different approaches
1. **Create comparison matrices** when applicable
1. **Develop recommendations** based on use cases

### Phase 4: Documentation Creation

1. **Create persistent research document** at `./research/[topic-name].md`
1. **Structure as a living wiki**:
...
1. **Depth**: Go beyond surface-level descriptions to implementation details
1. **Balance**: Present multiple viewpoints and acknowledge uncertainty
1. **Currency**: Prioritize recent developments while noting historical context
1. **Practicality**: Include real-world considerations, not just theory
1. **Connectedness**: Show how different approaches relate to each other
...
1. **Cross-referencing**: Link to related research documents
1. **Living documents**: Update as new information emerges
1. **Searchable**: Structure with clear headings and consistent formatting
1. **Actionable**: Include decision support (when to use which approach)
...
1. **Deep dives**: Investigate each branch thoroughly
1. **Synthesis**: Connect findings across branches
1. **Documentation**: Create the persistent record
1. **Future updates**: Mark open questions and areas for future research
